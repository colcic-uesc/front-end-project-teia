  ...
  return (
        <section className='w-screen h-auto p-8 mt-16 flex flex-col justify-start gap-8'>
            ...
            <div className='w-auto flex flex-row justify-start gap-6'>
                <button className='bg-slate-400 h-10 px-8 rounded-lg drop-shadow-lg font-medium text-gray-200'><Link href='/login'>Login</Link></button>
                <button className='bg-slate-600 h-10 px-8 rounded-lg drop-shadow-lg font-medium text-gray-200'><Link href='/cadastro'>Cadastre-se</Link></button>
            </div>
        </section>
  )
}
